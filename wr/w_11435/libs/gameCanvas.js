...
(lib.Symbol7 = function(mode,startPosition,loop) {
	...
	// Layer 2
	this.text = new createjs.Text("Reset", "15px Tahoma", "#333333");
	this.text.lineHeight = 17;
	this.text.lineWidth = 41;
	this.text.setTransform(30,3);
...
(lib.time_txt = function() {
	...
	this.shape.graphics.f("#333333").s().p("").cp();
	this.shape.setTransform(21.2,6.6);
...
(lib.score_txt = function() {
	...
	// Layer 1
	this.shape_2 = new createjs.Shape();
	this.shape_2.graphics.f("#333333").s().p("").cp();
	this.shape_2.setTransform(24.8,6.7);
...
(lib.ge = function() {
	...
	// Layer 1
	this.enterscore = new createjs.Text("", "18px Tahoma","#666666");
	this.enterscore.textAlign = "Left";
	this.enterscore.lineHeight = 18;
	this.enterscore.lineWidth = 39;
	this.enterscore.setTransform(567,315.5,1,1);

	this.entertimemin = new createjs.Text("", "18px Tahoma","#666666");
	...
	this.text_1 = new createjs.Text(":", "18px Tahoma","#666666");
	this.text_1.textAlign = "center";
	this.text_1.lineHeight = 18;
	this.text_1.setTransform(582,282,1,1);

	this.entertimesec = new createjs.Text("", "18px Tahoma","#666666");
